...
|---|---|---:|
| archetype_cluster_plus | 260310_val40_dedup_archetype_cluster_plus | 4666/4666 |
...
|---|---:|---:|---:|---:|
| archetype_cluster_plus | 5.1950 | 0.6985 | 0.6910 | 0.7062 |
...
| continuous | archetype_cluster_plus | 2544 | 4.2925 | 0.2146 | NaN | NaN |
| continuous | random_baseline | 2544 | 8.8494 | 0.4425 | NaN | NaN |
| all-or-nothing | archetype_cluster | 2065 | 8.4649 | 0.4232 | 0.5768 | 0.7063 |
| all-or-nothing | archetype_cluster_plus | 2122 | 6.2771 | 0.3139 | 0.6861 | 0.7943 |
...
|---|---|---:|---:|---:|---:|---|
| contrib_mae (↓ better) | archetype_cluster_plus vs archetype_cluster | 5.1950 | 7.8772 | -2.6822 | 0.0000 | yes |
| contrib_mae (↓ better) | archetype_cluster_plus vs random_baseline | 5.1950 | 9.3628 | -4.1677 | 0.0000 | yes |
| contrib_mae (↓ better) | archetype_cluster vs random_baseline | 7.8772 | 9.3628 | -1.4856 | 0.0000 | yes |
| target_f1 (↑ better) | archetype_cluster_plus vs archetype_cluster | 0.6985 | 0.6958 | 0.0027 | 0.8453 | no |
| target_f1 (↑ better) | archetype_cluster_plus vs random_baseline | 0.6985 | 0.7341 | -0.0355 | 0.0002 | yes |
| target_f1 (↑ better) | archetype_cluster vs random_baseline | 0.6958 | 0.7341 | -0.0382 | 0.0001 | yes |
| action_exact_match (↑ better) | archetype_cluster_plus vs archetype_cluster | 0.6910 | 0.6897 | 0.0012 | 0.8990 | no |
| action_exact_match (↑ better) | archetype_cluster_plus vs random_baseline | 0.6910 | 0.7325 | -0.0415 | 0.0000 | yes |
| action_exact_match (↑ better) | archetype_cluster vs random_baseline | 0.6897 | 0.7325 | -0.0427 | 0.0000 | yes |
| target_hit_any (↑ better) | archetype_cluster_plus vs archetype_cluster | 0.7062 | 0.7019 | 0.0043 | 0.7816 | no |
| target_hit_any (↑ better) | archetype_cluster_plus vs random_baseline | 0.7062 | 0.7360 | -0.0298 | 0.0018 | yes |
