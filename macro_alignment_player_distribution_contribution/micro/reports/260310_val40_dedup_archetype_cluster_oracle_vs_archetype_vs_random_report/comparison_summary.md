...
|---|---|---:|
| archetype_cluster_oracle_treatment | 260310_val40_dedup_archetype_cluster_oracle_treatment | 4666/4666 |
...
|---|---:|---:|---:|---:|
| archetype_cluster_oracle_treatment | 7.1513 | 0.6974 | 0.6897 | 0.7055 |
...
| continuous | archetype_cluster_oracle_treatment | 2544 | 6.8742 | 0.3437 | NaN | NaN |
| continuous | random_baseline | 2544 | 8.8494 | 0.4425 | NaN | NaN |
| all-or-nothing | archetype_cluster | 2065 | 8.4649 | 0.4232 | 0.5768 | 0.7063 |
| all-or-nothing | archetype_cluster_oracle_treatment | 2122 | 7.4835 | 0.3742 | 0.6258 | 0.7506 |
...
|---|---|---:|---:|---:|---:|---|
| contrib_mae (↓ better) | archetype_cluster_oracle_treatment vs archetype_cluster | 7.1513 | 7.8772 | -0.7259 | 0.0001 | yes |
| contrib_mae (↓ better) | archetype_cluster_oracle_treatment vs random_baseline | 7.1513 | 9.3628 | -2.2115 | 0.0000 | yes |
| contrib_mae (↓ better) | archetype_cluster vs random_baseline | 7.8772 | 9.3628 | -1.4856 | 0.0000 | yes |
| target_f1 (↑ better) | archetype_cluster_oracle_treatment vs archetype_cluster | 0.6974 | 0.6958 | 0.0016 | 0.9456 | no |
| target_f1 (↑ better) | archetype_cluster_oracle_treatment vs random_baseline | 0.6974 | 0.7341 | -0.0366 | 0.0001 | yes |
| target_f1 (↑ better) | archetype_cluster vs random_baseline | 0.6958 | 0.7341 | -0.0382 | 0.0001 | yes |
| action_exact_match (↑ better) | archetype_cluster_oracle_treatment vs archetype_cluster | 0.6897 | 0.6897 | -0.0001 | 0.9944 | no |
| action_exact_match (↑ better) | archetype_cluster_oracle_treatment vs random_baseline | 0.6897 | 0.7325 | -0.0428 | 0.0000 | yes |
| action_exact_match (↑ better) | archetype_cluster vs random_baseline | 0.6897 | 0.7325 | -0.0427 | 0.0000 | yes |
| target_hit_any (↑ better) | archetype_cluster_oracle_treatment vs archetype_cluster | 0.7055 | 0.7019 | 0.0036 | 0.8412 | no |
| target_hit_any (↑ better) | archetype_cluster_oracle_treatment vs random_baseline | 0.7055 | 0.7360 | -0.0304 | 0.0014 | yes |
