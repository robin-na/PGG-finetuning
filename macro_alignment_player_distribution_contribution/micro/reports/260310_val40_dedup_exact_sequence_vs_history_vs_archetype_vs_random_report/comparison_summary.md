...
|---|---|---:|
| exact_sequence_archetype | 260310_val40_dedup_exact_sequence_archetype | 4609/4609 |
...
|---|---:|---:|---:|---:|
| exact_sequence_archetype | 6.6383 | 0.7574 | 0.7427 | 0.7694 |
...
| continuous | exact_sequence_archetype | 2544 | 5.5094 | 0.2755 | NaN | NaN |
...
| all-or-nothing | exact_sequence_archetype | 2065 | 8.0291 | 0.4015 | 0.5985 | 0.7098 |
...
|---|---|---:|---:|---:|---:|---|
| contrib_mae (↓ better) | exact_sequence_archetype vs history_archetype | 6.6383 | 4.9594 | 1.6789 | 0.0000 | yes |
| contrib_mae (↓ better) | exact_sequence_archetype vs archetype_cluster | 6.6383 | 7.8772 | -1.2389 | 0.0000 | yes |
| contrib_mae (↓ better) | exact_sequence_archetype vs random_baseline | 6.6383 | 9.3628 | -2.7245 | 0.0000 | yes |
...
| target_f1 (↑ better) | exact_sequence_archetype vs history_archetype | 0.7574 | 0.6923 | 0.0651 | 0.0000 | yes |
| target_f1 (↑ better) | exact_sequence_archetype vs archetype_cluster | 0.7574 | 0.6958 | 0.0615 | 0.0000 | yes |
| target_f1 (↑ better) | exact_sequence_archetype vs random_baseline | 0.7574 | 0.7341 | 0.0233 | 0.0117 | yes |
...
| action_exact_match (↑ better) | exact_sequence_archetype vs history_archetype | 0.7427 | 0.6646 | 0.0781 | 0.0000 | yes |
| action_exact_match (↑ better) | exact_sequence_archetype vs archetype_cluster | 0.7427 | 0.6897 | 0.0529 | 0.0000 | yes |
| action_exact_match (↑ better) | exact_sequence_archetype vs random_baseline | 0.7427 | 0.7325 | 0.0102 | 0.2774 | no |
...
| target_hit_any (↑ better) | exact_sequence_archetype vs history_archetype | 0.7694 | 0.7140 | 0.0553 | 0.0000 | yes |
| target_hit_any (↑ better) | exact_sequence_archetype vs archetype_cluster | 0.7694 | 0.7019 | 0.0675 | 0.0000 | yes |
| target_hit_any (↑ better) | exact_sequence_archetype vs random_baseline | 0.7694 | 0.7360 | 0.0334 | 0.0003 | yes |
