...
def system_header(env: Dict, demographics_text: str, include_reasoning: bool) -> str:
...
def system_header_plain(env: Dict, demographics_text: str, include_reasoning: bool) -> str:
    return "\n".join(system_header_lines(env, demographics_text, include_reasoning))
