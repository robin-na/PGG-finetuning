...
- [`forecasting/build_batch_inputs.py`](build_batch_inputs.py)
- [`forecasting/README.md`](README.md)
...
- [`non-PGG_generalization/task_grounding/TWIN_EXTENDED_PROFILE_SPEC.md`](../non-PGG_generalization/task_grounding/TWIN_EXTENDED_PROFILE_SPEC.md)
- [`non-PGG_generalization/task_grounding/build_twin_extended_profiles.py`](../non-PGG_generalization/task_grounding/build_twin_extended_profiles.py)
- [`non-PGG_generalization/task_grounding/render_twin_extended_profile_cards.py`](../non-PGG_generalization/task_grounding/render_twin_extended_profile_cards.py)

Prompt-facing Twin cards:

- [`non-PGG_generalization/task_grounding/output/twin_extended_profile_cards/pgg_prompt_min/twin_extended_profile_cards.jsonl`](../non-PGG_generalization/task_grounding/output/twin_extended_profile_cards/pgg_prompt_min/twin_extended_profile_cards.jsonl)
...
- [`non-PGG_generalization/task_grounding/PGG_VALIDATION_DEMOGRAPHIC_ONLY_PROFILES.md`](../non-PGG_generalization/task_grounding/PGG_VALIDATION_DEMOGRAPHIC_ONLY_PROFILES.md)
- [`non-PGG_generalization/task_grounding/sample_pgg_demographic_only_profiles_for_validation.py`](../non-PGG_generalization/task_grounding/sample_pgg_demographic_only_profiles_for_validation.py)

Prompt-facing demographic-only cards:

- [`non-PGG_generalization/task_grounding/output/pgg_validation_demographic_only_sampling_row_resampled/seed_0/demographic_profile_cards.jsonl`](../non-PGG_generalization/task_grounding/output/pgg_validation_demographic_only_sampling_row_resampled/seed_0/demographic_profile_cards.jsonl)
...
- [`non-PGG_generalization/task_grounding/TWIN_TO_PGG_VALIDATION_PERSONA_SAMPLING.md`](../non-PGG_generalization/task_grounding/TWIN_TO_PGG_VALIDATION_PERSONA_SAMPLING.md)
- [`non-PGG_generalization/task_grounding/output/twin_to_pgg_validation_persona_sampling/seed_0/game_assignments.jsonl`](../non-PGG_generalization/task_grounding/output/twin_to_pgg_validation_persona_sampling/seed_0/game_assignments.jsonl)

### Unadjusted Twin assignment

- [`non-PGG_generalization/task_grounding/output/twin_to_pgg_validation_persona_sampling_unadjusted/seed_0/game_assignments.jsonl`](../non-PGG_generalization/task_grounding/output/twin_to_pgg_validation_persona_sampling_unadjusted/seed_0/game_assignments.jsonl)

### Demographic-only assignment

- [`non-PGG_generalization/task_grounding/output/pgg_validation_demographic_only_sampling_row_resampled/seed_0/game_assignments.jsonl`](../non-PGG_generalization/task_grounding/output/pgg_validation_demographic_only_sampling_row_resampled/seed_0/game_assignments.jsonl)
...
- [`forecasting/batch_input/baseline_gpt_5_1.jsonl`](batch_input/baseline_gpt_5_1.jsonl)
- [`forecasting/batch_input/demographic_only_row_resampled_seed_0_gpt_5_1.jsonl`](batch_input/demographic_only_row_resampled_seed_0_gpt_5_1.jsonl)
- [`forecasting/batch_input/twin_sampled_seed_0_gpt_5_1.jsonl`](batch_input/twin_sampled_seed_0_gpt_5_1.jsonl)
- [`forecasting/batch_input/twin_sampled_unadjusted_seed_0_gpt_5_1.jsonl`](batch_input/twin_sampled_unadjusted_seed_0_gpt_5_1.jsonl)
...
- raw request JSONL goes in `forecasting/batch_input/`
- raw batch result JSONL goes in `forecasting/batch_output/`
- run-specific metadata goes in `forecasting/metadata/<run_name>/`
...
- [`forecasting/parse_outputs.py`](parse_outputs.py)

Evaluation and analysis:

- [`forecasting/evaluate_outputs.py`](evaluate_outputs.py)
- [`forecasting/analyze_vs_human_treatments.py`](analyze_vs_human_treatments.py)
- [`forecasting/compare_models_with_noise_ceiling.py`](compare_models_with_noise_ceiling.py)
- [`forecasting/plot_macro_pointwise_alignment.py`](plot_macro_pointwise_alignment.py)
- [`forecasting/analyze_micro_distribution_alignment.py`](analyze_micro_distribution_alignment.py)
- [`forecasting/ANALYSIS_OVERVIEW.md`](ANALYSIS_OVERVIEW.md)
- [`forecasting/registry/analysis_registry.csv`](registry/analysis_registry.csv)

Representative result directories:

- [`forecasting/results/baseline_gpt_5_1__vs_human_treatments`](results/baseline_gpt_5_1__vs_human_treatments)
- [`forecasting/results/demographic_only_row_resampled_seed_0_gpt_5_1__vs_human_treatments`](results/demographic_only_row_resampled_seed_0_gpt_5_1__vs_human_treatments)
- [`forecasting/results/twin_sampled_seed_0_gpt_5_1__vs_human_treatments`](results/twin_sampled_seed_0_gpt_5_1__vs_human_treatments)
- [`forecasting/results/twin_sampled_unadjusted_seed_0_gpt_5_1__vs_human_treatments`](results/twin_sampled_unadjusted_seed_0_gpt_5_1__vs_human_treatments)
...
1. read this file
2. read [`forecasting/README.md`](README.md)
...
4. read [`non-PGG_generalization/task_grounding/TWIN_TO_PGG_VALIDATION_PERSONA_SAMPLING.md`](../non-PGG_generalization/task_grounding/TWIN_TO_PGG_VALIDATION_PERSONA_SAMPLING.md)
5. read [`non-PGG_generalization/task_grounding/PGG_VALIDATION_DEMOGRAPHIC_ONLY_PROFILES.md`](../non-PGG_generalization/task_grounding/PGG_VALIDATION_DEMOGRAPHIC_ONLY_PROFILES.md)
6. inspect [`forecasting/build_batch_inputs.py`](build_batch_inputs.py)
7. inspect one run in `forecasting/metadata/`
8. inspect the matched result directory in `forecasting/results/`
...
- [`forecasting/registry/experiment_registry.csv`](registry/experiment_registry.csv)
- [`forecasting/registry/analysis_registry.csv`](registry/analysis_registry.csv)
...
- `non-PGG_generalization/task_grounding/` constructs the augmentation sources and seat assignments
