...
This directory contains machine-readable lookup tables for the PGG forecasting pipeline.
...
One row per run manifest found in `forecasting/pgg/metadata/`.

Important fields:

- `run_name`: concrete run identifier used throughout `pgg/batch_input/`, `pgg/metadata/`, and `pgg/results/`
