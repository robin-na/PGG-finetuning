...
- Twin persona pool: `PGG-finetuning/non-PGG_generalization/twin_profiles/output/twin_extended_profiles/twin_extended_profiles.jsonl`
- prompt-facing card pool: `PGG-finetuning/non-PGG_generalization/twin_profiles/output/twin_extended_profile_cards/pgg_prompt_min/twin_extended_profile_cards.jsonl`
...
- `PGG-finetuning/non-PGG_generalization/twin_profiles/output/twin_extended_profile_cards/pgg_prompt_min/twin_extended_profile_cards.jsonl`
...
- `PGG-finetuning/forecasting/pgg/profile_sampling/output/twin_to_pgg_validation_persona_sampling/seed_0`
...
- `PGG-finetuning/forecasting/pgg/profile_sampling/output/twin_to_pgg_validation_persona_sampling_unadjusted/seed_0`
...
- `PGG-finetuning/non-PGG_generalization/twin_profiles/output/twin_extended_profile_cards/pgg_prompt_min/shared_prompt_notes.md`
...
```bash
python PGG-finetuning/forecasting/pgg/profile_sampling/sample_twin_personas_for_pgg_validation.py
```
