...
from .chip_bargain import build_prompt as build_chip_bargain
from .longitudinal_trust_game_ht863 import build_prompt as build_longitudinal_trust_game_ht863
from .minority_game_bret_njzas import build_prompt as build_minority_game_bret_njzas
from .multi_game_llm_fvk2c import build_prompt as build_multi_game_llm_fvk2c
...
def get_prompt_builder(dataset_key: str) -> PromptBuilder:
    mapping: dict[str, PromptBuilder] = {
