...
METRICS = [
    ...
    ("prosociality_index_wd", "Cross-Game Trust Proxy"),
]


def main() -> None:
    forecasting_root = Path(__file__).resolve().parent.parent
    plot_dir = (
        forecasting_root
        / "results"
    ...
    fig, axes = plt.subplots(1, len(METRICS), figsize=(5.3 * len(METRICS), 4.4), squeeze=False)
    ...
    fig.tight_layout()
    output_path = plot_dir / "simple_composite_comparison.png"
