...
This file is descriptive only. It should match the currently committed outputs in `forecasting/results/` and should not be treated as a second source of truth over the manifests.
...
- `forecasting/results/micro_distribution_alignment__llms/`
