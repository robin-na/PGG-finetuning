...
PROJECT_ROOT = FORECASTING_ROOT.parent
REGISTRY_DIR = FORECASTING_ROOT / "registry"
METADATA_DIR = FORECASTING_ROOT / "metadata"
RESULTS_DIR = FORECASTING_ROOT / "results"
    ...
    rows.append(
        {
            ...
            "script": "forecasting/analyze_vs_human_treatments.py",
            "output_location": "forecasting/results/<run_name>__vs_human_treatments/",
    ...
    rows.append(
        {
            ...
            "script": "forecasting/compare_models_with_noise_ceiling.py",
            "output_location": "forecasting/results/model_comparison__noise_ceiling/",
    ...
    rows.append(
        {
            ...
            "script": "forecasting/plot_macro_pointwise_alignment.py",
            "output_location": "forecasting/results/macro_pointwise_alignment__llms/",
    ...
    rows.append(
        {
            ...
            "script": "forecasting/analyze_micro_distribution_alignment.py",
            "output_location": "forecasting/results/micro_distribution_alignment__llms/",
    ...
    rows.append(
        {
            ...
            "script": "forecasting/analyze_twin_profile_behavior_links.py",
            "output_location": "forecasting/results/twin_profile_behavior_links/",
