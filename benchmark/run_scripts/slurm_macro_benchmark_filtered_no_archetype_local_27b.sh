#!/bin/bash
# Local HF path on 1xA100 for no-archetype runs.
# No quantization. Defaults to Gemma 3 12B IT.
#SBATCH --job-name=pgg-bmk-m-noarch-l4
...
RUN_ID="${RUN_ID:-${SLURM_JOB_ID:-manual}_r${SLURM_RESTART_COUNT:-0}_macro_no_archetype_local_27b}"
