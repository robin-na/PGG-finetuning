#!/bin/bash
# Local HF path on 1xA100 for random archetype runs.
# No quantization. Defaults to Gemma 3 12B IT.
#SBATCH --job-name=pgg-bmk-m-rand-l12b
...
RUN_ID="${RUN_ID:-${SLURM_JOB_ID:-manual}_r${SLURM_RESTART_COUNT:-0}_macro_random_archetype_local_12b_s${SEED}}"
