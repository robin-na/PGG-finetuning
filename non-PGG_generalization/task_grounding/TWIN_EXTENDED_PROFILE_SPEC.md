...
- Schema: `non-PGG_generalization/task_grounding/twin_extended_profile_schema.json`
- Per-entry mapping: `non-PGG_generalization/task_grounding/twin_extended_profile_mapping.csv`
- Mapping builder: `non-PGG_generalization/task_grounding/build_twin_extended_profile_mapping.py`
- Profile builder: `non-PGG_generalization/task_grounding/build_twin_extended_profiles.py`
- Card schema: `non-PGG_generalization/task_grounding/twin_extended_profile_card_schema.json`
- Card renderer: `non-PGG_generalization/task_grounding/render_twin_extended_profile_cards.py`
- Card-distribution analysis: `non-PGG_generalization/task_grounding/analyze_twin_profile_card_distributions.py`
- Output JSONL: `non-PGG_generalization/task_grounding/output/twin_extended_profiles/twin_extended_profiles.jsonl`
- Output preview: `non-PGG_generalization/task_grounding/output/twin_extended_profiles/preview_twin_extended_profiles.json`
...
```bash
python non-PGG_generalization/task_grounding/build_twin_extended_profiles.py
```

Render readable cards from the structured profiles with:

```bash
python non-PGG_generalization/task_grounding/render_twin_extended_profile_cards.py --all-modes
```
