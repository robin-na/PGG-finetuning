...
- `PGG-finetuning/non-PGG_generalization/task_grounding/output/pgg_validation_demographic_only_sampling/seed_0`
...
- `PGG-finetuning/non-PGG_generalization/task_grounding/output/pgg_validation_demographic_only_sampling_row_resampled/seed_0`
...
```bash
python PGG-finetuning/non-PGG_generalization/task_grounding/sample_pgg_demographic_only_profiles_for_validation.py \
