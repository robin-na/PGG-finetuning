...
from .build_compact_observer_batch_inputs import _index_chat_log, _load_avatar_map, _load_game_rows
from .data import _parse_action_dict, load_wave_games
from .evaluate import _relative_efficiency
from .evaluate_compact_observer_outputs import (
    _build_avatar_mapping,
    _load_request_manifest,
    _parsed_rounds_to_round_records,
)
from .parse_compact_observer_outputs import _read_jsonl
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Compare k=0 generated rollouts against the human validation-wave treatment distribution."
    )
